...
ActiveRecord::Schema.define(version: 2020_09_18_073129) do
  ...
  create_table "buyeraddresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_buyeraddresses_on_user_id"
  end
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "transdate_id", null: false
  ...
  add_foreign_key "buyeraddresses", "users"
